...
status: Phase 6 completed, v1.0.0 skill enhanced
...
**Status:** Phase 6 completed, v1.0.0 enhanced
...
v1.0.0 includes intent resolution, query guardrails, and export scripts.
