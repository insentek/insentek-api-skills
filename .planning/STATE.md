...
status: Phase 6 completed, v2.0.0 skill enhanced
...
**Status:** Phase 6 completed, v2.0.0 enhanced
...
v2.0.0 adds intent resolution, query guardrails, and export scripts.
